...
_lr_signature = 'CHAR COMMA DIVIDE DO DOT ELSE EQUALS FLOAT FOR GT IDENTIFIER IF INT LBRACE LPAREN LT MINUS NUMBER PLUS QUOTE RBRACE RELOP RPAREN SEMICOLON TIMES WHILEprogram : statement\n                   | program statementstatement : declaration\n                     | assignment\n                     | while_loop\n                     | expression SEMICOLONdeclaration : INT IDENTIFIER SEMICOLON\n                       | INT IDENTIFIER EQUALS expression SEMICOLONassignment : IDENTIFIER EQUALS expression SEMICOLONexpression : expression PLUS term\n                      | expression MINUS term\n                      | termterm : term TIMES factor\n                | term DIVIDE factor\n                | factorfactor : NUMBER\n                  | IDENTIFIERcondition : expression RELOP expressionwhile_loop : WHILE LPAREN condition RPAREN LBRACE program RBRACE'
    
_lr_action_items = {'INT':([0,1,2,3,4,5,13,14,25,33,36,37,39,40,],[7,7,-1,-3,-4,-5,-2,-6,-7,-9,-8,7,7,-19,]),'IDENTIFIER':([0,1,2,3,4,5,7,13,14,15,16,18,19,20,21,25,26,33,35,36,37,39,40,],[8,8,-1,-3,-4,-5,17,-2,-6,23,23,23,23,23,23,-7,23,-9,23,-8,8,8,-19,]),'WHILE':([0,1,2,3,4,5,13,14,25,33,36,37,39,40,],[9,9,-1,-3,-4,-5,-2,-6,-7,-9,-8,9,9,-19,]),'NUMBER':([0,1,2,3,4,5,13,14,15,16,18,19,20,21,25,26,33,35,36,37,39,40,],[12,12,-1,-3,-4,-5,-2,-6,12,12,12,12,12,12,-7,12,-9,12,-8,12,12,-19,]),'$end':([1,2,3,4,5,13,14,25,33,36,40,],[0,-1,-3,-4,-5,-2,-6,-7,-9,-8,-19,]),'RBRACE':([2,3,4,5,13,14,25,33,36,39,40,],[-1,-3,-4,-5,-2,-6,-7,-9,-8,40,-19,]),'SEMICOLON':([6,8,10,11,12,17,22,23,24,27,30,31,32,],[14,-17,-12,-15,-16,25,-10,-17,-11,33,-13,-14,36,]),'PLUS':([6,8,10,11,12,22,23,24,27,29,30,31,32,38,],[15,-17,-12,-15,-16,-10,-17,-11,15,15,-13,-14,15,15,]),'MINUS':([6,8,10,11,12,22,23,24,27,29,30,31,32,38,],[16,-17,-12,-15,-16,-10,-17,-11,16,16,-13,-14,16,16,]),'EQUALS':([8,17,],[18,26,]),'TIMES':([8,10,11,12,22,23,24,30,31,],[-17,20,-15,-16,20,-17,20,-13,-14,]),'DIVIDE':([8,10,11,12,22,23,24,30,31,],[-17,21,-15,-16,21,-17,21,-13,-14,]),'LPAREN':([9,],[19,]),'RELOP':([10,11,12,22,23,24,29,30,31,],[-12,-15,-16,-10,-17,-11,35,-13,-14,]),'RPAREN':([10,11,12,22,23,24,28,30,31,38,],[-12,-15,-16,-10,-17,-11,34,-13,-14,-18,]),'LBRACE':([34,],[37,]),}
...
_lr_productions = [
  ...
  ('condition -> expression RELOP expression','condition',3,'p_condition','parser.py',62),
  ('while_loop -> WHILE LPAREN condition RPAREN LBRACE program RBRACE','while_loop',7,'p_while_loop','parser.py',66),
]
